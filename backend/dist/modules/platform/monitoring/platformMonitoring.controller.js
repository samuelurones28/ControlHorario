...
exports.PlatformMonitoringController = void 0;
class PlatformMonitoringController {
    static async getJobsStatus(request, reply) {
    ...
    static async getRecentErrors(request, reply) {
...
exports.PlatformMonitoringController = PlatformMonitoringController;
