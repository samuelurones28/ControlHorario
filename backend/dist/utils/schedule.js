...
exports.logDisconnectionViolation = exports.isOutsideSchedule = void 0;
const prisma_1 = require("./prisma");
const isOutsideSchedule = async (employeeId, companyId, date = new Date()) => {
    const dayOfWeek = date.getUTCDay(); // 0-6 (Sunday-Saturday)
    // Try to find employee specific schedule for today
    let schedule = await prisma_1.prisma.schedule.findUnique({
...
exports.isOutsideSchedule = isOutsideSchedule;
const logDisconnectionViolation = async (employeeId, action, details) => {
...
exports.logDisconnectionViolation = logDisconnectionViolation;
